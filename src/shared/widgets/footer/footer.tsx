...
function Footer() {
  return (
    <footer className='w-full bg-black text-white pt-10'>
        <div className='w-[95%] m-auto py-5 flex  flex-col sm:flex-row justify-between'>
            <div className="w-full md:w-[40%]">
                <Link href={'/'}>
                    <FooterLogo/>
                </Link>
                <p className='text-2xl mt-2'>
                    Get Mecodemy updates delivered directly to your inbox
                </p>
                <br />
      ...
      <p className="text-lg text-center pb-10">
        © 2024 Mecodemy, Inc. All rights reserved.
      </p>
    </footer>
  )
}
