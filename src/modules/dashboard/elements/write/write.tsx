...
const Write = () => {
  ...
  return (
    <div className="w-full flex p-5 flex-wrap gap-6 relative">
        ...
        {
            open && (
              <div className="absolute flex items-center justify-center top-0 left-0 bg-[#000028] h-screen w-full">
                <div className="w-[600px] p-5 bg-white rounded shadow relative">
                  ...
                  <input 
                  type="text" 
                  className="border border-black w-full h-[35px] px-2 mt-1 outline-none rounded"
                  value={emailTitle}
