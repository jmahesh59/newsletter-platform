...
import SubscribersCart from "@/shared/components/charts/subscribersCart";
...
function Main() {
  ...
  return (
    ...
    <p className='opacity-[.7] text-sm pt-2'>
      Hero&apos;s how your publication is doing
    </p>
      ...
      <div className="w-[35%] p-5">
        ...
        <div className="w-full bg-white border rounded p-5 my-3">
            ...
            <p className="text-sm opacity-[.7]">
              Learn how to get started on Mecodemy and utilize all our features,
